...
// received through the ESP32-C3 WiFi interface.
//
...
// the display.
//
// IP address for the ESP32-C3 is displayed on the scrolling display
// after startup initialization and connected to the WiFi network.
//
// Adapted for ESP32-C3 (tested against a "Super Mini" board): the
// original ESP32 VSPI pins (GPIO18/23/5) don't exist on the C3, so this
// uses the MD_MAX72XX "arbitrary pins" (software SPI / bit-banged)
// constructor instead of the hardware-SPI one. This module is an
// individually-chained 8x8 breakout (VCC/GND/DIN/CS/CLK header), not a
// fused 4-in-1 board, so HARDWARE_TYPE defaults to GENERIC_HW here — if
// the chained modules render mirrored or out of order, try FC16_HW,
// PAROLA_HW, or ICSTATION_HW instead.
//
// Connections (same as the rest of this project, see README.md):
// VCC       5V
// GND       GND
// DIN       GPIO5
// CS        GPIO6
...
// Change MAX_DEVICES to match how many 8x8 modules you have chained together
// (4 modules chained = 8x32).
#define HARDWARE_TYPE MD_MAX72XX::GENERIC_HW
#define MAX_DEVICES 4

// GPIO pins (ESP32-C3 Super Mini)
#define CLK_PIN   4
#define DATA_PIN  5
#define CS_PIN    6

// Arbitrary/software SPI pins - required on ESP32-C3, no VSPI/HSPI split like classic ESP32
